...
- **RoboComp codebase is located in** `https://github.com/robocomp/robocomp_core and the codegenerator in `https://github.com/robocomp/robocomp_tools`. 
...
**CORTEX code base in located in** `https://github.com/robocomp/cortex` and the DSR API documentation is available at `https://robocomp.github.io/cortex/`.
