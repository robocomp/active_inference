...
/** \mainpage RoboComp::cabinet_concept
 *
 * \section intro_sec Introduction
 *
 * The cabinet_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/cabinet_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "cabinet_concept"
#define SERVER_FULL_NAME   "RoboComp cabinet_concept::cabinet_concept"



class cabinet_concept : public Ice::Application
{
public:
	cabinet_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData cabinet_concept::getInitializationDataIce(){
...
void cabinet_concept::initialize()
{
...
int cabinet_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	cabinet_concept app(configFile, prefix, startup_check_flag);
