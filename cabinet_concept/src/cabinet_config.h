...
struct CabinetConfig
{
    ...
    bool  ricoh_confirm_enabled        = false;   // CabinetConcept.RicohConfirmEnabled
    ...
    float ricoh_confirm_detection_prob = 0.60f;   // CabinetConcept.RicohConfirmDetectionProb
    float ricoh_confirm_clutter_prob   = 0.15f;   // CabinetConcept.RicohConfirmClutterProb
