...
/** \mainpage RoboComp::chair_concept
 *
 * \section intro_sec Introduction
 *
 * The chair_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/chair_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "chair_concept"
#define SERVER_FULL_NAME   "RoboComp chair_concept::chair_concept"



class chair_concept : public Ice::Application
{
public:
	chair_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData chair_concept::getInitializationDataIce(){
...
int chair_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	chair_concept app(configFile, prefix, startup_check_flag);
