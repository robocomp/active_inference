...
// Mirrors table_concept/specificworker_presence.cpp, keyed on chair's PRIMARY input (the retina
...
void SpecificWorker::cleanup_owned_nodes()
{
    ...
    // and deleted each node by id — but [Owns].nodes already carries a WILDCARD ("chair_*") that
