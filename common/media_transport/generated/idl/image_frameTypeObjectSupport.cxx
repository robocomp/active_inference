...
void register_ImageFrame_type_identifier(
        TypeIdentifierPair& type_ids_ImageFrame)
{

    ReturnCode_t return_code_ImageFrame {eprosima::fastdds::dds::RETCODE_OK};
    return_code_ImageFrame =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "rc::media::ImageFrame", type_ids_ImageFrame);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_ImageFrame)
    {
        StructTypeFlag struct_flags_ImageFrame = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::FINAL,
                false, false);
        QualifiedTypeName type_name_ImageFrame = "rc::media::ImageFrame";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_ImageFrame;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_ImageFrame;
        AppliedAnnotationSeq tmp_ann_custom_ImageFrame;
        eprosima::fastcdr::optional<AppliedVerbatimAnnotation> verbatim_ImageFrame;
        if (!tmp_ann_custom_ImageFrame.empty())
        {
            ann_custom_ImageFrame = tmp_ann_custom_ImageFrame;
        }

        CompleteTypeDetail detail_ImageFrame = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_ImageFrame, ann_custom_ImageFrame, type_name_ImageFrame.to_string());
        CompleteStructHeader header_ImageFrame;
        header_ImageFrame = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_ImageFrame);
        CompleteStructMemberSeq member_seq_ImageFrame;
        {
            ...
            CompleteMemberDetail detail_frame_id = TypeObjectUtils::build_complete_member_detail(name_frame_id, member_ann_builtin_frame_id, ann_custom_ImageFrame);
        ...
        }
        {
            ...
            {
                ann_custom_ImageFrame = tmp_ann_custom_stream_id;
            }
            CompleteMemberDetail detail_stream_id = TypeObjectUtils::build_complete_member_detail(name_stream_id, member_ann_builtin_stream_id, ann_custom_ImageFrame);
            CompleteStructMember member_stream_id = TypeObjectUtils::build_complete_struct_member(common_stream_id, detail_stream_id);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_stream_id);
        }
        {
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_width = TypeObjectUtils::build_complete_member_detail(name_width, member_ann_builtin_width, ann_custom_ImageFrame);
            CompleteStructMember member_width = TypeObjectUtils::build_complete_struct_member(common_width, detail_width);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_width);
        }
        {
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_height = TypeObjectUtils::build_complete_member_detail(name_height, member_ann_builtin_height, ann_custom_ImageFrame);
            CompleteStructMember member_height = TypeObjectUtils::build_complete_struct_member(common_height, detail_height);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_height);
        }
        {
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_step = TypeObjectUtils::build_complete_member_detail(name_step, member_ann_builtin_step, ann_custom_ImageFrame);
            CompleteStructMember member_step = TypeObjectUtils::build_complete_struct_member(common_step, detail_step);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_step);
        }
        {
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_format = TypeObjectUtils::build_complete_member_detail(name_format, member_ann_builtin_format, ann_custom_ImageFrame);
            CompleteStructMember member_format = TypeObjectUtils::build_complete_struct_member(common_format, detail_format);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_format);
        }
        {
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_size = TypeObjectUtils::build_complete_member_detail(name_size, member_ann_builtin_size, ann_custom_ImageFrame);
            CompleteStructMember member_size = TypeObjectUtils::build_complete_struct_member(common_size, detail_size);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_size);
        }
        {
            ...
            return_code_data =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "anonymous_array_byte_3686400", type_ids_data);
            ...
            if (eprosima::fastdds::dds::RETCODE_OK != return_code_data)
            {
                ...
                bool element_identifier_anonymous_array_byte_3686400_ec {false};
                TypeIdentifier* element_identifier_anonymous_array_byte_3686400 {new TypeIdentifier(TypeObjectUtils::retrieve_complete_type_identifier(type_ids_data, element_identifier_anonymous_array_byte_3686400_ec))};
                if (!element_identifier_anonymous_array_byte_3686400_ec)
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION, "Array element TypeIdentifier inconsistent.");
                    return;
                }
                EquivalenceKind equiv_kind_anonymous_array_byte_3686400 = EK_COMPLETE;
                if (TK_NONE == type_ids_data.type_identifier2()._d())
                {
                    equiv_kind_anonymous_array_byte_3686400 = EK_BOTH;
                }
                CollectionElementFlag element_flags_anonymous_array_byte_3686400 = 0;
                PlainCollectionHeader header_anonymous_array_byte_3686400 = TypeObjectUtils::build_plain_collection_header(equiv_kind_anonymous_array_byte_3686400, element_flags_anonymous_array_byte_3686400);
                {
                    LBoundSeq array_bound_seq;
                        TypeObjectUtils::add_array_dimension(array_bound_seq, static_cast<LBound>(3686400));

                    PlainArrayLElemDefn array_ldefn = TypeObjectUtils::build_plain_array_l_elem_defn(header_anonymous_array_byte_3686400, array_bound_seq,
                                eprosima::fastcdr::external<TypeIdentifier>(element_identifier_anonymous_array_byte_3686400));
                    if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                            TypeObjectUtils::build_and_register_l_array_type_identifier(array_ldefn, "anonymous_array_byte_3686400", type_ids_data))
                    {
                        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                            "anonymous_array_byte_3686400 already registered in TypeObjectRegistry for a different type.");
                    }
                }
            }
            ...
            ann_custom_ImageFrame.reset();
            CompleteMemberDetail detail_data = TypeObjectUtils::build_complete_member_detail(name_data, member_ann_builtin_data, ann_custom_ImageFrame);
            CompleteStructMember member_data = TypeObjectUtils::build_complete_struct_member(common_data, detail_data);
            TypeObjectUtils::add_complete_struct_member(member_seq_ImageFrame, member_data);
        }
        CompleteStructType struct_type_ImageFrame = TypeObjectUtils::build_complete_struct_type(struct_flags_ImageFrame, header_ImageFrame, member_seq_ImageFrame);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_ImageFrame, type_name_ImageFrame.to_string(), type_ids_ImageFrame))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "rc::media::ImageFrame already registered in TypeObjectRegistry for a different type.");
        }
    }
}
