...
RgbIngestor::RgbIngestor(std::shared_ptr<DSR::DSRGraph> graph, const bool* enabled, std::string camera_node)
...
RgbIngestor::~RgbIngestor()
{
    sub_.reset();
}

bool RgbIngestor::try_discover()
{
