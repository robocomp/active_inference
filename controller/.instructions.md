...
**RoboComp core helper classes used in recent developments:**
- `doublebuffer_sync`: `/home/pbustos/robocomp/robocomp_core/classes/doublebuffer_sync/doublebuffer_sync.h`
- `doublebuffer_sync` threadpool helper: `/home/pbustos/robocomp/robocomp_core/classes/doublebuffer_sync/threadpool.h`
- `fps` helper: `/home/pbustos/robocomp/robocomp_core/classes/fps/fps.h`
- `AbstractGraphicViewer` base class: `/home/pbustos/robocomp/robocomp_core/classes/abstract_graphic_viewer/abstract_graphic_viewer.h`

**CORTEX headers and source files that are useful when working on DSR-driven agents:**
- Main DSR API: `/home/pbustos/robocomp/components/cortex/api/include/dsr/api/dsr_api.h`
- RT / frame transforms: `/home/pbustos/robocomp/components/cortex/api/include/dsr/api/dsr_inner_eigen_api.h`
- DSR Eigen aliases and transform types: `/home/pbustos/robocomp/components/cortex/api/include/dsr/api/dsr_eigen_defs.h`
- Attribute/value types: `/home/pbustos/robocomp/components/cortex/core/include/dsr/core/types/common_types.h`
- Attribute/value implementation: `/home/pbustos/robocomp/components/cortex/core/types/common_types.cpp`
- Graph viewer classes: `/home/pbustos/robocomp/components/cortex/gui/include/dsr/gui/viewers/graph_viewer/graph_viewer.h`
- Laser widget example: `/home/pbustos/robocomp/components/cortex/gui/include/dsr/gui/viewers/graph_viewer/graph_node_laser_widget.h`

**Sibling component references that helped with the controller viewer integration:**
- Room concept viewer: `/home/pbustos/robocomp/components/active_inference/room_concept/src/viewer_2d.h`
- Room concept viewer implementation: `/home/pbustos/robocomp/components/active_inference/room_concept/src/viewer_2d.cpp`
- Room concept custom widget: `/home/pbustos/robocomp/components/active_inference/room_concept/src/custom_widget.h`

**Path caveat:**
- In this machine there are two RoboComp trees in active use: `/home/pbustos/robocomp/...` for local development sources and `/home/robocomp/robocomp/...` for installed interfaces and generated-build dependencies. Check both before assuming a header or IDSL location is missing.

**doublebuffer_sync integration note:**
- `genericworker.h` can pull in the older RoboComp `doublebuffer` implementation, which clashes with `doublebuffer_sync` helper names such as `empty_fn` and `is_iterable`. If you include both in the same translation unit, use the local macro-rename pattern already applied in `src/viewer_2d.h` before including `doublebuffer_sync.h`.
