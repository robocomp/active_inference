...
#define SERVER_FULL_NAME   "RoboComp controller::controller"
...
class controller : public Ice::Application
{
public:
	controller (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData controller::getInitializationDataIce(){
...
int main(int argc, char* argv[])
{
	...
	controller app(configFile, prefix, startup_check_flag);
