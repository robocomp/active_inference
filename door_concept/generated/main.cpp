...
/** \mainpage RoboComp::door_concept
 *
 * \section intro_sec Introduction
 *
 * The door_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/door_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "door_concept"
#define SERVER_FULL_NAME   "RoboComp door_concept::door_concept"



class door_concept : public Ice::Application
{
public:
	door_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData door_concept::getInitializationDataIce(){
...
int door_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	door_concept app(configFile, prefix, startup_check_flag);
