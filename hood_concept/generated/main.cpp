...
/** \mainpage RoboComp::hood_concept
 *
 * \section intro_sec Introduction
 *
 * The hood_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/hood_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "hood_concept"
#define SERVER_FULL_NAME   "RoboComp hood_concept::hood_concept"



class hood_concept : public Ice::Application
{
public:
	hood_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData hood_concept::getInitializationDataIce(){
...
int hood_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	hood_concept app(configFile, prefix, startup_check_flag);
