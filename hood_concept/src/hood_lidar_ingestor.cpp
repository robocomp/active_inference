/*
 *    hood_lidar_ingestor.cpp  —  see hood_lidar_ingestor.h (port of bottle_lidar_ingestor.cpp)
 */

#include "hood_lidar_ingestor.h"
...
HoodLidarIngestor::HoodLidarIngestor(std::shared_ptr<DSR::DSRGraph> graph, DSR::InnerEigenAPI* inner_eigen,
...
HoodLidarIngestor::~HoodLidarIngestor()
{
    reader_.reset();
}

bool HoodLidarIngestor::pump()
{
    helios_fresh_ = false;
    bpearl_fresh_ = false;
