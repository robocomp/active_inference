/*
 *    hood_rgb_ingestor.cpp  —  see hood_rgb_ingestor.h
 */

#include "hood_rgb_ingestor.h"
...
HoodRgbIngestor::HoodRgbIngestor(std::shared_ptr<DSR::DSRGraph> graph, const HoodConfig& cfg)
...
HoodRgbIngestor::~HoodRgbIngestor()
{
    sub_.reset();
}

bool HoodRgbIngestor::try_discover()
{
