...
void SpecificWorker::refresh_belief_strip()
{
    ...
    rc::dash::fill_strip(belief_strip_, fitter_->instances(), *G,
        [](rc::BeliefStripRow& r, const auto& inst)
        {
            ...
            rc::dash::fill_certainty(r, inst.ai2_belief.covariance_reported(), rc::kHoodDofs);
        });
}
...
void SpecificWorker::refresh_belief_inspector()
{
    ...
    for (const auto& [id, inst] : fitter_->instances())
    {
        ...
        rc::dashboard::fill_dofs(c, rc::kHoodDofs, v, S);
        ...
        rc::dashboard::fill_cov(c, S, rc::HoodBelief::N);
...
void SpecificWorker::build_dashboard()
{
    const rc::dashboard::BuildSpec spec{
        .agent        = QStringLiteral("hood_concept"),
        .series_title = QStringLiteral("Hood — Free Energy, Surprise, Belief Uncertainty & Residuals"),
        .strip_title  = QStringLiteral("hoods — beliefs"),
        .strip_label  = QStringLiteral("hoods"),
