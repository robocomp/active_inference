...
/** \mainpage RoboComp::human_concept
 *
 * \section intro_sec Introduction
 *
 * The human_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/human_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "human_concept"
#define SERVER_FULL_NAME   "RoboComp human_concept::human_concept"



class human_concept : public Ice::Application
{
public:
	human_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData human_concept::getInitializationDataIce(){
...
int human_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	human_concept app(configFile, prefix, startup_check_flag);
