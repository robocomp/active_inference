...
/** \mainpage RoboComp::kinova_controller
 *
 * \section intro_sec Introduction
 *
 * The kinova_controller component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/kinova_controller --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "kinova_controller"
#define SERVER_FULL_NAME   "RoboComp kinova_controller::kinova_controller"
...
class kinova_controller : public Ice::Application
{
public:
	kinova_controller (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData kinova_controller::getInitializationDataIce(){
...
void kinova_controller::initialize()
{
...
int kinova_controller::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	kinova_controller app(configFile, prefix, startup_check_flag);
