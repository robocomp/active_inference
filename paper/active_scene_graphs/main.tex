...
panoramic camera; and P3Bot, a second differential-drive robot with a different LiDAR and no
panoramic camera. The fleet of agents is identical on all three, and only the robot concept differs.
