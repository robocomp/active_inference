...
/** \mainpage RoboComp::refrigerator_concept
 *
 * \section intro_sec Introduction
 *
 * The refrigerator_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/refrigerator_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "refrigerator_concept"
#define SERVER_FULL_NAME   "RoboComp refrigerator_concept::refrigerator_concept"



class refrigerator_concept : public Ice::Application
{
public:
	refrigerator_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData refrigerator_concept::getInitializationDataIce(){
...
void refrigerator_concept::initialize()
{
...
int refrigerator_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	refrigerator_concept app(configFile, prefix, startup_check_flag);
