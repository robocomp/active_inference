/*
 * epistemic_planner.h  —  AI2-native next-best-view proposal for the refrigerator-concept agent.
 *
 * Scores each of the four vertical refrigerator faces by the D-optimal expected entropy reduction on the belief's
 ...
 * BELIEF half (Σ, ΔI, the adequacy gap to Σ*); that module owns the SENSOR half. Reference: REFRIGERATOR.md §10.
 */
...
// Stateless next-best-view scorer over the four vertical refrigerator faces.
...
public:
    ...
    ///                   the floor datum. The VERTICAL channel is not optional for a refrigerator: a 1.7 m box
    ...
    ///                   practice for this concept: a refrigerator stands against a wall, so the viewpoints of
