...
struct RefrigeratorConfig
{
    ...
    int   support_bank_max_points        = 4000;    // cap on the refrigerator-owned support-point memory bank
    ...
    // DIAGNOSTIC one-shot: if non-empty, dump a fitted refrigerator's accumulated support-bank point cloud (room
