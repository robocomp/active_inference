 ...
 * per-frame sensor/diagnostics snapshots, the refrigerator-owned voxel memory bank, the existence log-odds, and
...
struct RefrigeratorInstance
{
    ...
    // ── Refrigerator-owned voxel memory bank (room frame), independent of per-frame uploads ──────────────
