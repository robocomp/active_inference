/*
 *    refrigerator_lidar_ingestor.cpp  —  see refrigerator_lidar_ingestor.h (port of bottle_lidar_ingestor.cpp)
 */

#include "refrigerator_lidar_ingestor.h"
...
RefrigeratorLidarIngestor::RefrigeratorLidarIngestor(std::shared_ptr<DSR::DSRGraph> graph, DSR::InnerEigenAPI* inner_eigen,
...
RefrigeratorLidarIngestor::~RefrigeratorLidarIngestor()
{
    reader_.reset();
}

bool RefrigeratorLidarIngestor::pump()
{
    helios_fresh_ = false;
    bpearl_fresh_ = false;
