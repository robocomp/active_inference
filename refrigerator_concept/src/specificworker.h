...
private:
    // The fit (observe/infer/belief/voxel-bank) lives in rc::RefrigeratorFitter; perception in
    ...
    std::unique_ptr<rc::RefrigeratorLidarIngestor>             lidar_ingestor_;   // YOLO-independent LiDAR range channel
