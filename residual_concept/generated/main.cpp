...
/** \mainpage RoboComp::residual_concept
 *
 * \section intro_sec Introduction
 *
 * The residual_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/residual_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "residual_concept"
#define SERVER_FULL_NAME   "RoboComp residual_concept::residual_concept"
...
class residual_concept : public Ice::Application
{
public:
	residual_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData residual_concept::getInitializationDataIce(){
...
void residual_concept::initialize()
{
...
int residual_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	residual_concept app(configFile, prefix, startup_check_flag);
