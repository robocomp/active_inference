...
/** \mainpage RoboComp::ring_metaconcept
 *
 * \section intro_sec Introduction
 *
 * The ring_metaconcept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/ring_metaconcept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "ring_metaconcept"
#define SERVER_FULL_NAME   "RoboComp ring_metaconcept::ring_metaconcept"



class ring_metaconcept : public Ice::Application
{
public:
	ring_metaconcept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData ring_metaconcept::getInitializationDataIce(){
...
void ring_metaconcept::initialize()
{
...
int ring_metaconcept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	ring_metaconcept app(configFile, prefix, startup_check_flag);
