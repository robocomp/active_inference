...
/** \mainpage RoboComp::robot_concept
 *
 * \section intro_sec Introduction
 *
 * The robot_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/robot_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "robot_concept"
#define SERVER_FULL_NAME   "RoboComp robot_concept::robot_concept"
...
class robot_concept : public Ice::Application
{
public:
	robot_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData robot_concept::getInitializationDataIce(){
...
int robot_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	RoboCompMediaPlaneDDS::MediaPlaneDDSPrxPtr mediaplanedds_proxy4;
	...
	require<RoboCompMediaPlaneDDS::MediaPlaneDDSPrx, RoboCompMediaPlaneDDS::MediaPlaneDDSPrxPtr>(communicator(),
	                    configLoader.get<std::string>("Proxies.MediaPlaneDDS4"), "MediaPlaneDDSProxy4", mediaplanedds_proxy4);
	...
	tprx = std::make_tuple(camera360rgb_proxy,camera360rgbd_proxy,camerargbdsimple_proxy,imu_proxy,lidar3d_proxy,mediaplanedds_proxy,mediaplanedds_proxy1,mediaplanedds_proxy2,mediaplanedds_proxy3,mediaplanedds_proxy4);
...
int main(int argc, char* argv[])
{
	...
	robot_concept app(configFile, prefix, startup_check_flag);
