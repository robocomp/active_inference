...
closed-loop run on a real LiDAR model. The pale band is ground truth; the estimate lies inside its
width throughout, the two differing by \SI{5}{} and \SI{12}{\milli\meter}, which is why a hairline
would be hidden under the estimate's own stroke. \emph{Left}, after \SI{681}{\second} parked: the
