...
carrying its measured value and signed error. Discs: per-corner $\sigma$, to scale. The robot is drawn
to scale, with its heading and its bearing relative to the room. \emph{Left}, parked for
\SI{665}{\second}: the geometry is already within \SI{15}{\milli\meter} of truth, yet every corner
declares almost a metre of uncertainty and the layout is withheld. \emph{Right}, the first publishable
frame, after turning \SI{319}{\degree} on the spot: the geometry moves by at most
\SI{19}{\milli\meter} while corner $\sigma$ falls by a factor of \num{21}. The estimator does not earn
...
\emph{The gate is a tolerance, not a tuned parameter.} The \SI{6}{\centi\meter} bound is the
...
\emph{The shape was right before the confidence was.} Standing still, the estimate was already
