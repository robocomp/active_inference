...
\begin{enumerate}
  ...
  component differs by \num{5}$\times$ between the two settings we measure it in and by
  \num{2}$\times$ between motion states, which suggests systematic error is context-dependent rather
  than captured by a fixed scalar (\S\ref{sec:notconstant}).
