...
struct RoomConfig
{
    ...
    float       ODOM_INJECT_SCALE_V     = 0.0f;  // std of a multiplicative scale DRAWN ONCE per process
    float       ODOM_INJECT_SCALE_OMEGA = 0.0f;  // std of a multiplicative scale DRAWN ONCE per process
