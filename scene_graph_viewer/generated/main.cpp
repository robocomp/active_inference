...
/** \mainpage RoboComp::scene_graph_viewer
 *
 * \section intro_sec Introduction
 *
 * The scene_graph_viewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/scene_graph_viewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "scene_graph_viewer"
#define SERVER_FULL_NAME   "RoboComp scene_graph_viewer::scene_graph_viewer"



class scene_graph_viewer : public Ice::Application
{
public:
	scene_graph_viewer (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData scene_graph_viewer::getInitializationDataIce(){
...
void scene_graph_viewer::initialize()
{
...
int scene_graph_viewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	scene_graph_viewer app(configFile, prefix, startup_check_flag);
