...
/** \mainpage RoboComp::table_concept
 *
 * \section intro_sec Introduction
 *
 * The table_concept component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/table_concept --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "table_concept"
#define SERVER_FULL_NAME   "RoboComp table_concept::table_concept"



class table_concept : public Ice::Application
{
public:
	table_concept (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData table_concept::getInitializationDataIce(){
...
int table_concept::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	table_concept app(configFile, prefix, startup_check_flag);
