/*
 * mask_ingestor.cpp — YOLO "masks" DSR node reading for table_concept.
 */
...
std::optional<MaskIngestor::MaskSlice> MaskIngestor::select_for_table(const TableInstance& inst) const
{
