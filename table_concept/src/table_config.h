...
struct TableConfig
{
    ...
    bool  ricoh_confirm_enabled        = false;   // TableConcept.RicohConfirmEnabled
    ...
    float ricoh_confirm_detection_prob = 0.60f;   // TableConcept.RicohConfirmDetectionProb
    float ricoh_confirm_clutter_prob   = 0.15f;   // TableConcept.RicohConfirmClutterProb
