/*
 * table_voxel_bank.h — this agent's ADAPTER onto common/voxel_bank.
 *
 * The bank itself (ownership gate, dedup grid, cap, counters, readout) is shared and lives in
 * common/voxel_bank/voxel_bank.h. What stays here is the only part that is genuinely about a table: how to
