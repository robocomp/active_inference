...
/** \mainpage RoboComp::viewer3d
 *
 * \section intro_sec Introduction
 *
 * The viewer3d component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/viewer3d --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "viewer3d"
#define SERVER_FULL_NAME   "RoboComp viewer3d::viewer3d"



class viewer3d : public Ice::Application
{
public:
	viewer3d (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData viewer3d::getInitializationDataIce(){
...
int viewer3d::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	viewer3d app(configFile, prefix, startup_check_flag);
